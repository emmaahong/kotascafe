...
class CustomerNew(pg.sprite.Sprite):
    def __init__(self, movex, movey, center, image_path, items):
    ...
    @classmethod
    def cust1(cls):
        return cls(10, 10, (-50, 120), pg.image.load("imagesProjec/customer1.png"), ["Sandwich", "Croissant"])